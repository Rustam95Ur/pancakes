                    ...
                    @foreach($products as $product)
                        <div class="recommendation__item">
                            <a href="{{$product->link}}" target="_blank">
                                <div class="product-unit" data-id="{{$product->id}}">
    ...
    <section id="social">
        ...
        <div class="container">
            <div class="row text-center">
                <div class="col-md-4">
                    <p class="social-footer-icon"><i class="fa fa-instagram"></i></p>
                    <h5>Instagram</h5>
                </div>
                <div class="col-md-4">
                    <p class="social-footer-icon"><i class="fa fa-yelp"></i></p>
                    <h5>Yelp</h5>
                </div>
                <div class="col-md-4">
                    <p class="social-footer-icon"><i class="fa fa-facebook-official"></i></p>
                    <h5>Facebook</h5>
                </div>
            </div>
        </div>
